...
1. Check `docs/reference/technical-preferences.md` for any "tone", "voice", or "style"
   fields or sections.
...
1. Glob for `docs/patch-notes-template.md` and `docs/reference/templates/patch-notes-template.md`.
