...
- Read `docs/reference/technical-preferences.md` to identify the engine and version
...
Use the template structure from `docs/reference/templates/game-design-document.md`:
...
Before finalizing the GDD, spawn `creative-director` via Task using gate **CD-GDD-ALIGN** (`docs/reference/director-gates.md`).
...
> **To validate this GDD, open a fresh Antigravity session and run:**
...
> open a fresh Antigravity session and run `/design-system [system-name]` — it will
