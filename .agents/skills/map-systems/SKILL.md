...
**After dependency mapping is approved, spawn `technical-director` via Task using gate TD-SYSTEM-BOUNDARY (`docs/reference/director-gates.md`) before proceeding to priority assignment.**
...
**After priorities are approved, spawn `producer` via Task using gate PR-SCOPE (`docs/reference/director-gates.md`) before writing the index.**
...
Using the template at `docs/reference/templates/systems-index.md`, populate the
...
**After the systems index is written, spawn `creative-director` via Task using gate CD-SYSTEMS (`docs/reference/director-gates.md`).**
...
> `design/gdd/systems-index.md`. Open a fresh Antigravity session to continue
