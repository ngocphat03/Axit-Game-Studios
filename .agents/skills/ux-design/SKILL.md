...
> "Player journey map not yet created. Template available at `docs/reference/templates/player-journey.md`. Run `/ux-design` Phase 2b or create it manually to establish player context for this screen."
...
Read `docs/reference/technical-preferences.md` and extract the `## Input & Platform`
