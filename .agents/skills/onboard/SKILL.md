...
Read GEMINI.md for project overview and standards.

Read the relevant agent definition from `docs/reference/agent-roster.md` if a specific role is specified.
