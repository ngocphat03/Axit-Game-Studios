...
Read the target file(s) in full. Read GEMINI.md for project coding standards.

---

## Phase 2: Identify Engine Specialists

Read `docs/reference/technical-preferences.md`, section `## Engine Specialists`. Note:
