...
- [`Skill Spec v1`](skill-spec-v1.md) — một quy trình tái sử dụng tập trung, được thể hiện dưới dạng file `SKILL.md` tương thích với Antigravity.
...
- Tính tương thích với Antigravity không được phép chi phối toàn bộ kiến trúc Axit.
- Các Core/system/workspace Skill đang hoạt động phải duy trì tính hợp lệ của file `SKILL.md` chuẩn Antigravity khi được hiển thị để khám phá.
...
- Coi thư mục gốc repository là workspace khi Antigravity chạy từ gốc và các System tương tác dùng chung repository.
